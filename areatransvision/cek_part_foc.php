...
$vendor = mysql_query("SELECT DISTINCT
...
where sup.id_supplier='$id_supplier' and m.id_area='$login_area'
...
echo "<option value=''>Pilih Part</option>";
while($v = mysql_fetch_array($vendor)){
    echo "<option value=\"".$v['no_part']."\">".$v['part_description']."</option>\n";
    $data_part = array(
